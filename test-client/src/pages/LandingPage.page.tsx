...
const LandingPage: React.FC = () => {
    ...
    return (
        <>
            <div className="flex flex-col h-screen bg-lime-200 bg-canvas lg:items-center lg:px-56">
                <div className={`flex items-center h-28 ${debug && "bg-orange-100"}`}>
                    <h1 className="text-3xl font-bold mx-3 text-black bg-lime-200 p-8 lg:text-4xl">
                        copager
                    </h1>
                </div>
                <div className={`flex flex-col justify-center items-center ${debug && "bg-rose-100"} h-[26rem] text-center lg:bg-white lg:rounded-2xl lg:p-10 lg:border-4 lg:border-black shadow-solid-lg-screen`}>
                    ...
                    <p className='text-black/60 bg-lime-200 p-5 lg:text-lg lg:bg-white'>
                        Copager is an online LAN chat app that allows you to chat with people that are connected to the same wifi network as you.
                    </p>
                    <div className="flex flex-col w-full gap-4 bg-lime-200 px-5 lg:px-[10vw] lg:bg-white">
                        ...
                        <div className="flex justify-center items-center gap-[0.4rem] bg-lime-200 border-2 border-black w-full h-12 shadow-solid-primary lg:bg-white">
                            <div className='pb-[0.1rem]'>
