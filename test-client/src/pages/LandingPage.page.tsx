  ...
  return (
    <>
        <div className="flex flex-col h-screen font-poppins bg-lime-200 bg-canvas md:items-center md:px-56">
            ...
            <div className="flex flex-col justify-center items-center h-[26rem] text-center 
                        md:bg-white md:rounded-2xl md:p-10 md:border-4 md:border-black md:w-[45rem] 
                        lg:w-[53rem] shadow-solid-md-screen">
